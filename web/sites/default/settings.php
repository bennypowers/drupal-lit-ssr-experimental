...
$settings['hash_salt'] = 'FGBNFzO88MXXtapX';
...
$settings['config_sync_directory'] = '/mnt/files/config/sync_dir';
$settings['hash_salt'] = 'jL1zE/sGJKVKvQuI';
$settings['trusted_host_patterns'] = array(
    '\.localhost$', '\.local$', '\.loc$'
);
if ($trusted = getenv('DRUPAL_TRUSTED_HOST')) {
  array_push($settings['trusted_host_patterns'], '^'.$trusted.'$');
}
